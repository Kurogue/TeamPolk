...
# Set the geometry of the window to the full size of the screen
        ...
        ### ADD EMPLOYEE ###
        self.title_employee = Label(self, text="CREATE EMPLOYEE", bg=label_bg, fg=label_fg, font=("Verdana", 20))
        ...
        self.delete_employee_button.grid(column=0, row=11, pady=(20,0), padx=(20,0))
