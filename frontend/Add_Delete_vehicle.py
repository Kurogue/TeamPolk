...
class Vehicle_add_delete(Toplevel):
    def __init__(self, master=None):
        ...
        addVehicle_mileage_entry.grid(column=1, row=3, pady=(37.5,0), padx=(0, 150))
        ...
        addVehicle_package_entry.grid(column=1, row=3, pady=(37.5,0), padx=(0, 150))
        ...
        addVehicle_audio_entry.grid(column=1, row=3, pady=(37.5,0), padx=(0, 150))
        ...
        addVehicle_preformance_entry.grid(column=1, row=3, pady=(37.5,0), padx=(0, 150))
        ...
        addVehicle_interior_entry.grid(column=1, row=3, pady=(37.5,0), padx=(0, 150))
        ...
        addVehicle_exterior_entry.grid(column=1, row=3, pady=(37.5,0), padx=(0, 150))
        ...
        addVehicle_safety_entry.grid(column=1, row=3, pady=(37.5,0), padx=(0, 150))
        ...
        addVehicle_feature_entry.grid(column=1, row=3, pady=(37.5,0), padx=(0, 150))
        ...
        addVehicle_control_entry.grid(column=1, row=3, pady=(37.5,0), padx=(0, 150))

        addVehicle_button = Button(self, text="Add Vehicle", command=self.add_vehicle)
        addVehicle_button.grid(column=0, row=14, pady=(37.5,0), padx=(150, 0))
        
        deleteVehicle_button = Button(self, text="Add Vehicle", command=self.delete_vehicle)
