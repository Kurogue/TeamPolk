...
title_label = ttk.Label(root, text="ProTrack Automotive Systems", font=("Arial", 36, "bold"), background="#36454F", foreground="white")
title_label.place(x=20, y=20)

# Create a photoimage object of the image in the path
image1 = Image.open("frontend/carLogo.png")
image1 = image1.resize((300, 300), Image.ANTIALIAS)  # Resize the image
...
style = ttk.Style()
style.configure("TButton", foreground="#2A2A2D", background="#36454F", padding=20, font=("Arial", 12, "bold"))
...
locate_vehicle_label = tk.Label(root, width=50, text="Do you wish to find a Vehicle?", font=("Arial", 12), fg="white", bg="#36454F")
locate_vehicle_label.grid(column=0, row=0, padx=(400, 0), pady=(160, 20))
locate_vehicle_button = tk.Button(text="Yes", command=v_search, width=7, font=("Arial", 10, "bold"), bg="white", fg="#36454F")
locate_vehicle_button.grid(column=1, row=0, pady=(160, 20))

advLocate_vehicle_label = tk.Label(root, width=50, text="Here is an advanced vehicle search.", font=("Arial", 12), fg="white", bg="#36454F")
advLocate_vehicle_label.grid(column=0, row=1, padx=(400, 0), pady=(0, 20))
advLocate_vehicle_button = tk.Button(text="Yes", command=a_search, width=7, font=("Arial", 10, "bold"), bg="white", fg="#36454F")
advLocate_vehicle_button.grid(column=1, row=1, pady=(0, 20))

addBar = tk.Label(root, text="Add/Delete Vehicle", font=("Arial", 12), fg="white", bg="#36454F")
addButton = tk.Button(text="Yes", command=add_delete, width=7, font=("Arial", 10, "bold"), bg="white", fg="#36454F")
...
removeBar = tk.Entry(root, bg="white", font=("Arial", 12), foreground="gray")
removeBar.insert(0, "Enter vehicle ID to remove")
removeBar.bind('<FocusIn>', on_entry_click)
removeBar.bind('<FocusOut>', on_focus_out)
removeButton = tk.Button(text="Remove", width=7, font=("Arial", 10, "bold"), bg="white", fg="#36454F")
